  ...
  settings: {
    ...
    analysis: {
      ...
      filter: {
        ...
        infix_ngrams: {
          // This was defined but not used in analyzers, included for completeness
          type: "edge_ngram",
          min_gram: 2,
          max_gram: 15,
        },
      ...
      analyzer: {
        device_analyzer: {
          tokenizer: "standard",
          filter: ["lowercase", "asciifolding", "device_stopwords"],
        },
        trigrams: {
          tokenizer: "standard",
        ...
        en_prefix_phrase_ngrams_index_analyzer: {
          tokenizer: "keyword",
          filter: ["lowercase", "prefix_ngrams", "collapse"],
        },
        en_prefix_phrase_ngrams_query_analyzer: {
          tokenizer: "keyword",
          filter: ["lowercase", "en_stopwords", "collapse"],
        },
        en_prefix_token_ngrams_index_analyzer: {
          tokenizer: "standard",
          filter: ["lowercase", "prefix_ngrams"],
        },
        es_prefix_phrase_ngrams_index_analyzer: {
          tokenizer: "whitespace",
          filter: ["lowercase", "asciifolding", "prefix_ngrams", "collapse"],
        },
        ...
        es_prefix_token_ngrams_index_analyzer: {
          tokenizer: "standard",
          filter: ["lowercase", "asciifolding", "es_synonyms", "prefix_ngrams"],
        },
        ...
        en_classification_index_analyzer: {
          char_filter: ["replace_slashes", "remove_trailing_delimiters"],
          tokenizer: "whitespace",
          filter: ["lowercase", "en_stemmer", "collapse"],
        },
        ...
        es_classification_index_analyzer: {
          char_filter: ["replace_slashes", "remove_trailing_delimiters"],
          tokenizer: "whitespace",
          filter: ["lowercase", "asciifolding", "es_stemmer", "collapse"],
        },
  ...
  mappings: {
    ...
    properties: {
      ...
      steps_language_1: {
        type: "text",
        index: false,
        copy_to: ["description_language_1", "all_content_language_1"],
      },
      steps_language_2: {
        type: "text",
        index: false,
        copy_to: ["description_language_2", "all_content_language_2"],
      },
      steps_language_3: {
        type: "text",
        index: false,
        copy_to: ["description_language_3", "all_content_language_3"],
      },
      val: {
        type: "text",
        index: false,
      ...
      phrase_starts_with_language_1: {
        type: "text",
        analyzer: "en_prefix_phrase_ngrams_index_analyzer",
        search_analyzer: "en_prefix_phrase_ngrams_query_analyzer",
      },
      term_starts_with_language_1: {
        type: "text",
        analyzer: "en_prefix_token_ngrams_index_analyzer",
      ...
      phrase_starts_with_language_2: {
        type: "text",
        analyzer: "es_prefix_phrase_ngrams_index_analyzer",
        search_analyzer: "es_prefix_phrase_ngrams_query_analyzer",
      },
      term_starts_with_language_2: {
        type: "text",
        analyzer: "es_prefix_token_ngrams_index_analyzer",
        search_analyzer: "autocomplete_query_analyzer",
      },
      phrase_starts_with_language_3: {
        type: "text",
